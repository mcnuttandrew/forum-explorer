...
import {DEV_MODE, WEB_PAGE_MODE, SHOW_ALL_COMMENTS, TABLET_MODE_CONFIG, TOUR_STEPS} from '../constants';
...
class RootComponent extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={classnames({'tablet-mode': tabletMode})} id="extension-container">
        {this.props.showTour && (
          <Joyride
            continuous={true}
        ...
        <div className="flex-down full-size">
          ...
          />
          {showPicker && (
            <WebPagePicker getAllItems={this.props.getAllItems} setPageId={this.props.setPageId} />
          )}
          {showLoading && (
          ...
          {showDashboard && (
            <div className="flex full-size background-gray main-container">
              ...
              <CommentPanel
                ...
                itemPath={this.props.itemPath}
                itemsToRender={showAllComments ? this.props.dfsOrderedData : this.props.itemsToRender}
