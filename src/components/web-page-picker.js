  ...
  componentDidMount() {
    ...
    fetch('https://hacker-news.firebaseio.com/v0/topstories.json?print=pretty')
      ...
      .then((items) => {
        ...
        Promise.all(
          items.map((item) =>
            fetch(`https://hacker-news.firebaseio.com/v0/item/${item}.json`).then((result) => result.json()),
          ),
      ...
      <div className="background-gray picker-container">
        <div className="flex-down">
          ...
          <p>
            ...
            <a href={WEBSTORE_LINK}> You can download the chrome extension here.</a>
          </p>
          <p>
            ...
            Page count information is captured using the privacy respecting tracker `}
            <a href="https://umami.is/">umami</a>.
            {` We use IndexedDB for caching and make use of a cloud micro-service for our topic modeling. `}
          </p>
        </div>
