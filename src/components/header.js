...
function headerLinks(username) {
  ...
  const webPageModeLinks = [
    {name: 'home', link: location.href.includes('mcnutt.in') ? 'https://www.mcnutt.in/forum-explorer/' : '/'},
...
class Header extends React.Component {
  ...
  render() {
    ...
    const {rootId, username, setConfig, logoutLink, userKarma, configs} = this.props;
    ...
    return (
      <div className="header">
        ...
        {tooltipOpen && <div className="tooltip-container">{tooltip(configs, setConfig, toggleTooltip)}</div>}
        {!WEB_PAGE_MODE && (
