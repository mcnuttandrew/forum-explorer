...
%-------------------------------------------------------------------------
\begin{abstract}
Large threaded conversations, such as those found on reddit or slashdot, are often rendered in a manner that presents individual comments clearly but can obscure larger trends or patterns within the conversational corpus.
%
Previous works from the visualization community have addressed this problem through graphical-overviews and nlp-generated summaries.
%
...
%
We refine these approaches through the construction of a Chrome Extension, Forum Explorer, that implements novel design strategies that enable this type of representation to handle wider ranges of data in real time.
  \\
...
% TONE THIS NEXT SENTENCE DOWN PERHAPS
%
...
We address these problems through Forum Explorer, a Chrome Extension that repurposes the layout of yCombinator's social news website, HackerNews \cite{hackernews}, to facilitate better data exploration. %through the use of tree visualization techniques.
%
